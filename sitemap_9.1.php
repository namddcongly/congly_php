...
{
	$link='http://congly.com.vn'.Url::Link(array('cate_alias'=>$list_category[$item['cate_id']]['alias'],'title'=>$item['title'],'id'=>$item['id']),'news','congly_detail');
...
$data.= '<sitemap>';
$data.= '<loc>http://congly.com.vn/sitemaps/categories.xml</loc>';
...
{
	$data.= '<sitemap>';
	$data.= '<loc>http://congly.com.vn/sitemaps/news-'.date('Y',time()).'-'.$k.'.xml</loc>';
	$data.= '</sitemap>';
}
/*
for($i=12;$i >0;--$i)
{
$data.= '<sitemap>';
$data.= '<loc>http://congly.com.vn/sitemaps/news-2015-'.$i.'.xml</loc>';
$data.= '</sitemap>';
}
 * 
 */
...
{
$data.= '<sitemap>';
$data.= '<loc>http://congly.com.vn/sitemaps/news-2014-'.$i.'.xml</loc>';
$data.= '</sitemap>';
}
...
{
$data.= '<sitemap>';
$data.= '<loc>http://congly.com.vn/sitemaps/news-2013-'.$i.'.xml</loc>';
$data.= '</sitemap>';
}
$data.= '</sitemapindex>';
