...
Class BackendNews
{
    ...
    {
        $listField = 'id,user_id,cate_id,cate_path,cate_other,title,description,content,img1,img2,img3,img4,province_id,district_id,status,type_post,type,origin,author,tag,file,arrange,censor_id,reason_return,time_public,time_created,editor_id';
        global $TOTAL_ROWCOUNT;
        if ($wh)
            $where = "WHERE {$wh}";
        if ($order)
