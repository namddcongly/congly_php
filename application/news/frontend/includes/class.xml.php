...
$G=(int)date('G',time());
if(@$_GET['update_link'])
file_put_contents(ROOT_PATH.'esn.link.xml',file_get_contents('http://congly.esnc.net/linkmarket/getupdate.php?hour=00&mini=00&second=00&day='.date('D',time()).'&month='.date('n',time()).'&year=2018'));
